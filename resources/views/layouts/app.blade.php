...
<head>
    ...
    {{-- !!!!!!!!!!!!!!!!!getIdByUser NON RIMUOVERE!!!!!!!!!!!!!! --}}
    <meta name="user-id" @if (Auth::user() != null) content="{{ Auth::user()->id }}" @endif>
    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm">
            <div class="container bnb-container">
                ...
                {{-- burger menu button --}}
                <button class="navbar-toggler bnb-buttonStyle" type="button" data-toggle="collapse"
                    ...
                    <ul class="navbar-nav ml-auto ">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown  bnb-burgerMenu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right bnb-burgerMenu"
